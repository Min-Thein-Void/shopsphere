<template>
  <div
    ...
    <!-- Product Name -->
    <h5 class="text-lg font-semibold text-cyan-400 mt-2 tracking-tight leading-snug line-clamp-2 capitalize">
      {{ product.name }}
    </h5>
    ...
    <div class="flex items-center justify-between mt-auto">
      <div class="flex flex-col">
        <!-- Original Price (line-through if discount exists) -->
        <span v-if="product.discount_type" class="text-lg text-gray-400 line-through">
          ${{ product.price }}
        </span>
        <!-- Final Price -->
